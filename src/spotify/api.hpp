...
public:
    ...
    httplib::Result get(const string &url, utils::clock_t::duration cache_for = {});
    httplib::Result put(const string &url, const json &body = {});
    httplib::Result del(const string &url, const json &body = {});
