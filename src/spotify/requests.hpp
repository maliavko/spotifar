...
{
    followed_artists_requester(size_t limit):
...
struct artist_albums_requester: public api_collection_requester<albums_t>
{
    artist_albums_requester(const string &artist_id, size_t limit):
...
{
    album_tracks_requester(const string &album_id, size_t limit):
...
{
    user_playlists_requester(size_t limit):
...
{
    playlist_tracks_requester(const string &playlist_id, size_t limit):
