...
namespace spotifar
{
    namespace ui
    {
        ...
        const static string NONE_VIEW_ID = "";
        ...
        public:
            ...
            virtual std::string select_item(Api& api, const ItemFarUserData* data) = 0;
        ...
        public:
            ...
            virtual std::string select_item(Api& api, const ItemFarUserData* data);
        };
